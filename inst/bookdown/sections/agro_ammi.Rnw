...
\texttt{p\_out\_mean\_comparisons\_ammi} is a list of three elements with barplots :
...
If you wish to apply the AMMI workflow to several variables, you can use \texttt{lapply} with the following code :
