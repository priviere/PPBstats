...
The model is used to take into account environmental variation within a block with few control replicated in rows and columns.
...
- the linear effects for the rows (row),
- the linear effects for the columns (col), 
- the linear interaction of rows and columns (row:col),
- the main row effect (f(row)),
- the main column effect (f(col)),
- the smooth varying coefficient terms regarding rows (f(col):row),
- the smooth varying coefficient terms regarding columns (row:f(col))),
