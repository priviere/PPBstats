...
There are two format supported : `data-organo-hedonic` and `data-organo-napping`.

#### `data-organo-hedonic`

`data-organo-hedonic` format corresponds to 

```{r}
#data("data_hedonic")
#data_hedonic = format_data_PPBstats(data_hedonic, type = "data_organo_hedonic")
#head(data_hedonic)
```
...
`data-organo-napping` format corresponds to

```{r}
#data(data_napping)
#data_napping = format_data_PPBstats(data_napping, type = "data_organo_napping")
#head(data_napping)
```
