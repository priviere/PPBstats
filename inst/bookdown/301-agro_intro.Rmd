...
This distribution could not be calculated explicitely for the hierarchical model used in here (see section \@ref{model-1} and section \@ref{model-2}) but could be estimated using Markov Chain and Monte Carlo (MCMC) methods.
