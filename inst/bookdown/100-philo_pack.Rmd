...
More information can be found [here](../CONTRIBUTING.html).
...
To install the package, follow the instructions [here](../articles/1.install.html).
...
and download the data used in this tutorial (this is useful to earn lots of time!) [here](https://github.com/priviere/PPBstats/releases/download/v0.26/data_PPBstats.zip).
