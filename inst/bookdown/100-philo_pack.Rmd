...
Please, feel free to contribute to other aspects of analysis, see [here](https://priviere.github.io/PPBstats_web_site/contribute.html) for more information.
...
- **To improve the prediction of a target variable for selection** throught analysis of agronomic and nutritional traits but this is not done in `PPBstats`.
...
and download the data used in this tutorial (this is useful to earn lots of time!) [here](https://github.com/priviere/PPBstats/releases/download/v0.23/data_PPBstats.zip).
