...
```{r}
p_barplot_mu = plot(out_mean_comparisons_model_1_mu, plot_type = "barplot")
names(p_barplot_mu)
```
...
```{r}
p_interaction = plot(out_mean_comparisons_model_1_mu, plot_type = "interaction")
...
```{r}
p_score = plot(out_mean_comparisons_model_1_mu, plot_type = "score")
