...
Five types of plot, throught the `plot_type` argument are possible:
...
the factor to display in color (`in_col` argument), and of course the variable to describe (`vec_variables` argument).
