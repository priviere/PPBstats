### model_bh_GxE to analyse $G \times E$ interaction in the network of farms (**M7b**) {#model-2}
...
```{r}
# out_cross_validation_model_bh_GxE = cross_validation_model_bh_GxE(data_model_bh_GxE, "y1", nb_iterations = 10)
...
```{r}
ptp = predict_the_past_model_bh_GxE(out_check_model_bh_GxE, env = "loc-6:year-5")
```
