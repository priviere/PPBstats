...
For `ggplot.type = "biplot-alpha-beta"`, the biplot with $\alpha_i$ on the x axis and $\beta_i$ on the y axis.
...
and visualize the output, for `ggplot.type = "barplot"`, there is two colors regarding estimated and predicted results.
...
For `ggplot.type = "score"` and `ggplot.type = "interaction"`, predicted and estimated are mention between brakets after germplasm name.
