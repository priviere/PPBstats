...
knitr::include_graphics("../bookdown/figures/Logo-Diversifood.jpg")
```

```{r, out.width='15%', fig.align='center', echo=FALSE}
knitr::include_graphics("../bookdown/figures/Logo-SOLIBAM.jpg")
```

```{r, out.width='15%', fig.align='center', echo=FALSE}
knitr::include_graphics("../bookdown/figures/Logo-EU.jpg")
```

```{r, out.width='15%', fig.align='center', echo=FALSE}
knitr::include_graphics("../bookdown/figures/Logo-FdF.jpg")
```
