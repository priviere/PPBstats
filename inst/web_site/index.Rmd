...
**Baptiste Rouger^2^** tested the package, updated and wrote code regarding some functions
...
- [download and install `PPBstats`](https://priviere.github.io/PPBstats_web_site/download.html)
...
- [find references where `PPBstats` is cited](https://priviere.github.io/PPBstats_web_site/refs.html)
