...
- to have in a single package all kind of analysis found within PPB programmes with an exhaustive documentation
- to create a community working on PPB programmes in order to improve the package and exchange on how to deal with data coming from PPB programmes.
...
`PPBstats` is developed on Github by severals persons:
