...
The easiest way to start is to look at the present book to know how the package works.
...
knitr::include_graphics("../bookdown/figures/PPBstats-secondary-functions-1.png")
```

```{r workflow-2-2, out.width='100%', fig.align='center', echo=FALSE, fig.cap="Internal functions used within main functions (2/2)"}
knitr::include_graphics("../bookdown/figures/PPBstats-secondary-functions-2.png")
```
