...
First, load the current development version of the package: [download v0.23](https://github.com/priviere/PPBstats/archive/v0.23.zip)
...
knitr::include_graphics("../bookdown/figures/secondary-functions.png")
```
...
The book thanks to [`bookdown`](https://bookdown.org/yihui/bookdown/).
...
If you are not familiar with the code, you can edit `docx` documents that can be downloaded [here](https://github.com/priviere/PPBstats/releases/download/v0.23/PPBstats_vignette_docx.zip).
