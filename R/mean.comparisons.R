  ...
  # let's go !!! ----------
{
  ...
  if( !is.element(attributes(out_check_model)$PPBstats.object, c("check_model_model_1", "check_model_model_2", "checl_model_GxE")) ) { stop("The MCMC object should come from check_model.") } 
