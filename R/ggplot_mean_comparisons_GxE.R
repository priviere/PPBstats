ggplot_mean_comparisons_GxE = function(
  ...
  ggplot_LSDbarplot = function(d_LSD, variable){
  ...
  # 2. Germplasm
  ggplot_LSDbarplot_germplasm = ggplot_LSDbarplot(data_ggplot_LSDbarplot_germplasm, variable)
  
  # 3. Location
  ggplot_LSDbarplot_location = ggplot_LSDbarplot(data_ggplot_LSDbarplot_location, variable)
  
  # 4. Year
  ggplot_LSDbarplot_year = ggplot_LSDbarplot(data_ggplot_LSDbarplot_year, variable)
