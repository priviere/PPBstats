#' Plot hedonic object from format_data_PPBstats()
#'
#' @description
#' \code{plot.data_hedonic} gets ggplot to describe the data
#' 
#' @param data The data frame coming from format_data_PPBstats() with type = "data_organo_hedonic"
#' 
...
#' 
plot.data_organo_hedonic = function(  data,
                                      data_version = NULL,
