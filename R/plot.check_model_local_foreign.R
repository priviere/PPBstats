#' Get ggplot to visualize output from \code{\link{check_model.fit_model_local_foreign}}
#'
#' @description
#' \code{plot.check_model_local_foreign} returns ggplot to visualize outputs from \code{\link{check_model.fit_model_local_foreign}}
#'
#' @param x Output from \code{\link{check_model.fit_model_local_foreign}}
#'
