...
<<message=TRUE,cache=FALSE>>=
# get.PPBstats.data() waiting for the link to be ok
system("mkdir data")
system("cp -r /home/pierre/Documents/geek/R-stats/Rdev/PPBstats_data/*RData ./data")
@
...
load("./data/out.model1.RData") # # To save time
@
...
<<message=TRUE,cache=FALSE>>=
out1 = analyse.outputs(out.model1)
@
...
load("./data/out.model1_bis.RData") # To save (little) time

out1_bis = analyse.outputs(out.model1_bis, analysis = "convergence")
names(out1_bis$convergence) # parameters that did not converge
...
load("./data/comp.mu.RData") # To save time
@
...
load("./data/out.model2.RData") # To save time
@
...
load("./data/out.cv.RData") # to save lots of time
@
...
<<message=TRUE,cache=FALSE>>=
# out.model2 = FWH(PPBdata2, variable = "y1")
load("./data/out.model2.RData") # to save time

# out.model2_y2 = FWH(PPBdata2, variable = "y2")
load("./data/out.model2_y2.RData") # to save time

# out.model2_y3 = FWH(PPBdata2, variable = "y3")
load("./data/out.model2_y3.RData") # to save time
 
out2_y1 = analyse.outputs(out.model2)
...
# |==========================================================| 100%
load("./data/out.predict.the.past.RData") # to save time
