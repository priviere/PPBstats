...
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.model1.RData"}\hlstd{)} \hlcom{# # To save time}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{out1} \hlkwb{=} \hlkwd{analyse.outputs}\hlstd{(out.model1)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The experimental design plot is done.\\\#\# The two MCMC for each parameter converge thanks to the Gelman-Rubin test.\\\#\# The values of sigma in the inverse Gamme distribution are done.\\\#\# The mu\_ij posterior distributions are done.\\\#\# The beta\_jk posterior distributions are done.\\\#\# The sigma\_j posterior distributions are done.\\\#\# The standardised residuals distributions are done.}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{out1}\hlopt{$}\hlstd{experimental_design}\hlopt{$}\hlstd{plot}
\end{alltt}
\end{kframe}

{\centering \includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-7-1} 
...
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.model1_bis.RData"}\hlstd{)} \hlcom{# To save (little) time}

\hlstd{out1_bis} \hlkwb{=} \hlkwd{analyse.outputs}\hlstd{(out.model1_bis,} \hlkwc{analysis} \hlstd{=} \hlstr{"convergence"}\hlstd{)}
\hlkwd{names}\hlstd{(out1_bis}\hlopt{$}\hlstd{convergence)} \hlcom{# parameters that did not converge}
\end{alltt}
\begin{verbatim}
## [1] "nu"                  "rho"                
## [3] "sigma[env2-12:2011]" "sigma[env2-12:2012]"
## [5] "sigma[env2-14:2012]" "sigma[env2-3:2011]"
\end{verbatim}
\begin{alltt}
...
{\centering \includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-15-1} 
...
{\centering \includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-18-1} 
...
\hlkwd{load}\hlstd{(}\hlstr{"./data/comp.mu.RData"}\hlstd{)} \hlcom{# To save time}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-21-1} 
\includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-21-2} 
...
For environments with no controls, it may be useful to get the plot as well.
...
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.model2.RData"}\hlstd{)} \hlcom{# To save time}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{out2} \hlkwb{=} \hlkwd{analyse.outputs}\hlstd{(out.model2)}
\end{alltt}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{out2}\hlopt{$}\hlstd{experimental_design}\hlopt{$}\hlstd{plot}
\end{alltt}
\end{kframe}
...
An regression is also done between estimated and observed value.

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{# out.cv = cross.validation.FWH(data = PPBdata2, variable = "y1", nb_iterations = 10)}
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.cv.RData"}\hlstd{)} \hlcom{# to save lots of time}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{# out.model2 = FWH(PPBdata2, variable = "y1")}
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.model2.RData"}\hlstd{)} \hlcom{# to save time}

\hlcom{# out.model2_y2 = FWH(PPBdata2, variable = "y2")}
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.model2_y2.RData"}\hlstd{)} \hlcom{# to save time}

\hlcom{# out.model2_y3 = FWH(PPBdata2, variable = "y3")}
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.model2_y3.RData"}\hlstd{)} \hlcom{# to save time}

\hlstd{out2_y1} \hlkwb{=} \hlkwd{analyse.outputs}\hlstd{(out.model2)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The experimental design plot is done.\\\#\# The two MCMC for each parameter converge thanks to the Gelman-Rubin test.\\\#\# The alpha\_i posterior distributions are done.\\\#\# The beta\_i posterior distributions are done.\\\#\# The theta\_j posterior distributions are done.\\\#\# The standardised residuals distributions are done.}}\begin{alltt}
\hlstd{out2_y2} \hlkwb{=} \hlkwd{analyse.outputs}\hlstd{(out.model2_y2)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The experimental design plot is done.\\\#\# The two MCMC for each parameter converge thanks to the Gelman-Rubin test.\\\#\# The alpha\_i posterior distributions are done.\\\#\# The beta\_i posterior distributions are done.\\\#\# The theta\_j posterior distributions are done.}}\begin{alltt}
...
\hlcom{# |==========================================================| 100%}
\hlkwd{load}\hlstd{(}\hlstr{"./data/out.predict.the.past.RData"}\hlstd{)} \hlcom{# to save time}
...
\includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-49-2} 
\includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-49-3} 
\includegraphics[width=.6\textwidth]{figures/PPBstats_unnamed-chunk-49-4} 
