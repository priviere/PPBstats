...
\texttt{design\_experiment} & \\ \hline

\texttt{describe\_data} &  \\ \hline

\texttt{model\_1} & \\ \hline

\texttt{model\_2} & \\ \hline

\texttt{GxE} & \\ \hline

\texttt{check\_model} &  \\ \hline

\texttt{mean\_comparisons} &  \\ \hline

\texttt{parameter\_groups} &  \\ \hline

\texttt{cross\_validation\_model\_2} &  \\ \hline

\texttt{predict\_the\_past\_model\_2} &  \\ \hline

\texttt{biplot\_GxE} &  \\ \hline

\texttt{get\_ggplot} &  \\ \hline
...
\texttt{GxE\_build\_interaction\_matrix} & \\ \hline

\texttt{check\_model\_model\_1} & \\ \hline

\texttt{check\_model\_model\_2} & \\ \hline

\texttt{check\_model\_GxE} & \\ \hline

\texttt{parameter\_groups\_GxE} & \\ \hline

\texttt{parameter\_groups\_model\_2} & \\ \hline

\texttt{comp.parameters} & \\ \hline

\texttt{get.significant.groups} & \\ \hline

\texttt{get.at.least.X.groups} & \\ \hline

\texttt{mean\_comparisons\_GxE} & \\ \hline

\texttt{mean\_comparisons\_model\_2} & \\ \hline

\texttt{mean\_comparisons\_model\_1} & \\ \hline

\texttt{mean\_comparisons\_predict\_the\_past\_model\_2} & \\ \hline

\texttt{ggplot\_parameter\_groups} & \\ \hline

\texttt{ggplot\_check\_model\_GxE} & \\ \hline

\texttt{ggplot\_check\_model\_model\_1} & \\ \hline

\texttt{ggplot\_check\_model\_model\_2} & \\ \hline

\texttt{ggplot\_cross\_validation\_model\_2} & \\ \hline

\texttt{ggplot\_mean\_comparisons\_GxE} & \\ \hline

\texttt{ggplot\_mean\_comparisons\_model\_1} & \\ \hline

\texttt{ggplot\_mean\_comparisons\_model\_2} & \\ \hline

\texttt{ggplot\_mean\_comparisons\_predict\_the\_past\_model\_2} & \\ \hline

\texttt{ggplot\_biplot\_GxE} & \\ \hline

\texttt{ggplot\_discrimitiveness\_vs\_representativeness} & \\ \hline

\texttt{ggplot\_mean\_vs\_stability} & \\ \hline

\texttt{ggplot\_which\_won\_where} & \\ \hline
