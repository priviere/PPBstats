...
\item \textbf{involve all actors in the breeding decision process}: farmers, technicians, researchers, facolitators, consumers ... Such involvement empower all actors and answer the real needs of actors  \citep{sperling_framework_2001}.
