...
<<message=TRUE,cache=FALSE>>=
ammi = GxE(data_GxE, vec_variables, gxe_analysis = "AMMI")
@
...
\paragraph{residuals}
<<message=TRUE,cache=FALSE>>=
anova$residuals$distribution
@

<<message=TRUE,cache=FALSE>>=
anova$residuals$QQplot
@
...
<<message=TRUE,cache=FALSE>>=
pca$biplot$mean_vs_stability$mean_performance
@
...
<<message=TRUE,cache=FALSE>>=
pca$biplot$mean_vs_stability$stability_performance
@
...
It is interessting to assess the ability of the environments to discriminate the germplasms and their ability to represent the target environments. 
...
<<message=TRUE,cache=FALSE>>=
pca$biplot$discrimitiveness_vs_representativeness$discrimitiveness_vs_representativeness
@
