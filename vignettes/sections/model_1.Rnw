...
\item \texttt{data\_env\_with\_no\_controls} : dataframe with environnement with no controls
...
<<message=TRUE,cache=FALSE>>=
p_barplot_mu = get_ggplot(out_mean_comparisons_model_1_mu, ggplot.type = "barplot")
names(p_barplot_mu)
@
...
Lets' make the plots:
<<message=TRUE,cache=FALSE>>=
p_barplot_mu_version = get_ggplot(out_mean_comparisons_model_1_mu, data_version = data_version, ggplot.type = "barplot")
...
<<message=TRUE,cache=FALSE>>=
p_interaction = get_ggplot(out_mean_comparisons_model_1_mu, ggplot.type = "interaction")
...
<<message=TRUE,cache=FALSE>>=
p_score = get_ggplot(out_mean_comparisons_model_1_mu, ggplot.type = "score")
