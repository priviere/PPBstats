...
<<message=TRUE,cache=FALSE>>=
p_out_cv = get_ggplot(out_cross_validation_model_2)
@
...
p = get_ggplot(m_ptp, ggplot.type = "barplot")

data("data_version")
p = get_ggplot(m_ptp, data_version = data_version, ggplot.type = "barplot")

p = get_ggplot(m_ptp, ggplot.type = "score")

p = get_ggplot(m_ptp, ggplot.type = "interaction")
@
