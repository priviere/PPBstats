...
If you wish to apply the AMMI workflow to several variables, you can use the function \texttt{workflow\_gxe} presented in section \ref{workflow_gxe} with the following code :
