...
GVF test the package and updated the code regarding sections \ref{model1} and \ref{model2} \\
OD wrote the \texttt{JAGS} code and review the \texttt{R} code and the vignette regarding sections \ref{model1} and \ref{model2} \\
