...
\warning{Be aware that this package is under development and test: do not 100\% trust the functions!!! You're welcome to contribute. See \href{https://github.com/priviere/PPBstats/releases/download/v0.22/contribute_PPBstats.pdf}{here} for more details.}
...
FM reformated and improved all the code regarding S3 methods and improved the vignette by formating figure with Tikz \\
