...
\warning{Be aware that this package is under development and test: do not 100\% trust the functions!!! You're welcome to contribute. See  see \url{https://github.com/priviere/PPBstats/blob/master/vignettes/contribute.Rmd} for more details.}
