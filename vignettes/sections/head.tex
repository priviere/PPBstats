...
\warning{This package is under development and test : do not 100\% trust the functions !!! You're welcome to contribute. See section \ref{contribute} for more details.}
