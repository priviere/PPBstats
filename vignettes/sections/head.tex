...
\warning{Be aware that this package is under development and test : do not 100\% trust the functions !!! You're welcome to contribute. See section \ref{contribute} for more details.}
...
Gaelle Van Frank\textsuperscript{2} \hspace{1cm}
